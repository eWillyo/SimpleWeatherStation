...
float latitude = 49.010193;
float longitude = 17.122532;
String place = "Kyjov";
String openWeatherMapAPIKey = "cfbac157878c5745aa464bd36dddecb9";
...
char ssid[] = "EWILL";          //  your network SSID (name)
char password[] = "domacnost666";   // your network password
